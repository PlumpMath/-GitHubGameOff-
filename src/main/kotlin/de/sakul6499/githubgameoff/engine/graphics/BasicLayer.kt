...
abstract class BasicLayer(val name: String, internal var order: Int, internal var x: Int = 0, internal var y: Int = 0, internal val width: Int = Screen.GetWidth(), internal val height: Int = Screen.GetHeight()) {
